---
title: Sobre la Influencia de la Sobrecarga en el Ensayo de Penetración Estándar (SPT)
tags:
- Geotecnia
date: "2022-04-27"
---
...
# Introducción
En aquellos días en los cuales empezaba a surgir una preocupación por la estandarización de los resultados obtenidos en el [Ensayo de Penetración Estándar](notes/2022-04-25.md), **Gibbs & Holtz (1957)**[^1] fueron los primeros en obtener resultados experimentales que justifiquen la necesidad del uso de factores de corrección para el número de golpes $N$ medido en campo.
...
Adicionalmente a lo anterior, los mismos autores propusieron una formulación propia.
...
# Ajuste por Sobrecarga y Energía
...
Uno de los mayores atractivos del Ensayo SPT es la numerosa cantidad de correlaciones empíricas que se obtienen entre el índice $N$ y los diversos parámetros del suelo. Las siguientes formulaciones han sido obtenidas en arenas, siendo referenciadas constantemente a lo largo de la literatura.
