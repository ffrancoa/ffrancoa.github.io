...
**Bowles (1977)**[^1] en la segunda edición de su famoso "Foundation Analysis and Design" menciona algunas razones por las cuales, para la época de publicación de dicha edición, consideraba poco probable que en algún momento este ensayo llegase a ser descontinuado:
...
$$E_r = E_a \hspace{1pt}/\hspace{1pt} E_{in} = 396 \hspace{1pt}/\hspace{1pt} 475 = 0.67 $$
